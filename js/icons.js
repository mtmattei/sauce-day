...
const P = {
  ...
  // ---- timeline milestones ----
  cauldron:
    '<path d="M3.6 9.4h16.8v3.8a7.4 7.4 0 0 1-7.4 7.4h-2a7.4 7.4 0 0 1-7.4-7.4z"/>' +
    '<path d="M3.6 9.4h-1.4a1.5 1.5 0 0 1 0-3h1.4"/><path d="M20.4 9.4h1.4a1.5 1.5 0 0 0 0-3h-1.4"/>' +
    '<path d="M9 5.4c0-1.3 1.2-1.5 1.2-2.8"/><path d="M14 5.4c0-1.3 1.2-1.5 1.2-2.8"/>',

  coffee:
    '<path d="M4 7.6h13v6.6a4.4 4.4 0 0 1-4.4 4.4H8.4A4.4 4.4 0 0 1 4 14.2z"/>' +
    '<path d="M17 9.4h1.9a2.5 2.5 0 0 1 0 5H17"/>' +
    '<path d="M3.2 21h14.6"/>',
  ...
  pizza:
    '<path d="M12 3.2 3.6 19.4a1 1 0 0 0 1.3 1.3L21 12.4Z" transform="translate(-1 0)"/>' +
    '<circle cx="10.4" cy="12.8" r="1.15"/><circle cx="14.4" cy="10.4" r="1.15"/>' +
    '<circle cx="8.2" cy="16.8" r="1.05"/>',

  // cooling: a flake, because the jars must not be moved until they are cold
  cool:
    '<path d="M12 2.8v18.4"/><path d="M4 7.4l16 9.2"/><path d="M20 7.4L4 16.6"/>' +
    '<path d="M12 6.6 9.6 4.6"/><path d="m12 6.6 2.4-2"/>' +
    '<path d="M12 17.4l-2.4 2"/><path d="m12 17.4 2.4 2"/>',

  camera:
    '<path d="M3.6 7.8h4l1.6-2.4h5.6l1.6 2.4h4v11.6H3.6z"/>' +
